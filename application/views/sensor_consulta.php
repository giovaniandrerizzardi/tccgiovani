        ...
        <div class="col-md-10 col-xs-10 col-md-offset-1 " id="borda">
            <?php if ($this->session->userdata('nivel') == '1') { ?>
                <table id="myTable" class="table table-striped table-bordered sortable">
                    <caption><h2><?php echo $this->lang->line('table_title_sensor'); ?></h2></caption>
                    <thead>
                        <tr>
                            <th  class="col1">
                            ...
                            <th  class="col4">
                                ...
                                <?php echo $this->lang->line('max_corrente'); ?>
                            ...
                            <th  class="col5">
                                ...
                                <?php echo $this->lang->line('min_corrente'); ?>
                    ...
                    <tbody>
                        <?php
                        foreach ($sensor as $dados) {
                            ?>
                            <tr>
                                <td>
                                    <a href="<?php echo base_url('') ?>index.php/sensor/apagar_sensor/<?php echo $dados->SENSOR_COD; ?>" onClick="return confirm('<?php echo $this->lang->line('msg_confirm_delete') . " " . $this->lang->line('user') . " " . $this->lang->line('code') . ": " . $dados->SENSOR_COD; ?>?')">
                                        <img src="<?php echo base_url('includes/imagens/delete.png') ?>"></a>
                                    <a href="<?php echo base_url('') ?>index.php/sensor/editar_sensor/<?php echo $dados->SENSOR_COD; ?>">
                                        <img src="<?php echo base_url('includes/imagens/edit.png') ?>"></a>
                                </td>
                                <td><a href="<?php echo base_url('') ?>index.php/sensor/editar_sensor/<?php echo $dados->SENSOR_COD; ?>"><?php echo $dados->SENSOR_COD; ?></a></td>
                                <td><a href="<?php echo base_url('') ?>index.php/sensor/editar_sensor/<?php echo $dados->SENSOR_COD; ?>"><?php echo $dados->GANHO; ?></a></td>
                                <td><a href="<?php echo base_url('') ?>index.php/sensor/editar_sensor/<?php echo $dados->SENSOR_COD; ?>"><?php echo $dados->MAX_CORRENTE; ?></a></td>
                                <td><a href="<?php echo base_url('') ?>index.php/sensor/editar_sensor/<?php echo $dados->SENSOR_COD; ?>"><?php echo $dados->MIN_CORRENTE; ?></a></td>
